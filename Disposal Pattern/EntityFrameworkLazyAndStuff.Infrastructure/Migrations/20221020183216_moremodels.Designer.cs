...
namespace EntityFrameworkLazyAndStuff.Infrastructure.Migrations
{
    ...
    [Migration("20221020183216_moremodels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameworkLazyAndStuff.Infrastructure.Entities.ThirdTestModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MaTestModelId");

                    b.ToTable("ThirdTestModels");
                });
            ...
            modelBuilder.Entity("EntityFrameworkLazyAndStuff.Infrastructure.Entities.ThirdTestModel", b =>
                {
                    b.HasOne("EntityFrameworkLazyAndStuff.Infrastructure.Entities.MaTestModel", "MaTestModel")
                        .WithMany()
                        .HasForeignKey("MaTestModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MaTestModel");
                });
